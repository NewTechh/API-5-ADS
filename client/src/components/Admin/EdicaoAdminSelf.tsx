  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        const registroLogAcao = `Edição de dados do administrador`;
        const registroLogAlteracao = `Realizado a edição autônoma de dados do administrador ${administrador.administrador_nome}`;
